 ...
 */
public class MenuSolicitudController implements Initializable {
    ...
    @FXML
    private TableColumn<Solicitud, Integer> colIdBeneficiario;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        colIdBeneficiario.setCellValueFactory(new PropertyValueFactory<>("idBeneficiario"));
        colCompletado.setCellValueFactory(new PropertyValueFactory<>("realizada"));
        llenarTabla();
    }    
    
    private void llenarTabla(){
        String consulta= "SELECT * FROM Solicitud s";
        try{
